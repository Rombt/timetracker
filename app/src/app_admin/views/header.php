...
<head>
   ...
   <link rel="stylesheet" href="assets/styles/main-style.min.css?<?php echo rand( 10, 100 ) ?>" />
            ...
            <div class="rmbt-full-width rmbt-top-string-header-full-width">
               <section class="rmbt-container rmbt-top-string-header">
                  <div class="rmbt-top-string-header__row">
                     ...
                     <div class="rmbt-top-string-header__col header-logo">
                        <div class="wrap-img">
                           <img src="./assets/img/header-logo_color_1.png" alt="">
                        </div>
